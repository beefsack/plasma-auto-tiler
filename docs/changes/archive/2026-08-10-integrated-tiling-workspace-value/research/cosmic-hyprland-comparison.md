...
- Hyprland has no workspace-removal or workspace-reorder affordance
  ...
  interpretation flagged for the Lead)
...
## 8. Risks and Notes for the Lead
...
- Hyprland's D1.4 (reorder) and D1.3 (removal) are classified CB because no
  ...
  that is a rubric-interpretation decision for the Lead, not an evidence change.
...
- D9.1/D9.2/D9.4/D9.5/D9.6 for COSMIC and D9.1/D9.4/D9.5/D9.6 for Hyprland are
  ...
  U04-12) could close the remaining runtime question if the Lead authorizes it.
