...
Following `research/capture-method.md` Section 9: negotiate
...
package is a dependency change outside the documented authorization boundary
...
given the marginal value described below. Retrying
...
separate method calls without either a new dependency (outside the documented
authorization boundary) or new Rust code (explicitly excluded by
...
was nothing invasive to reverse. Verified directly after this attempt:
