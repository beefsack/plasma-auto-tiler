...
- [Prior Window Visual Effects Feasibility research](../window-visual-effects-feasibility/feasibility.md), especially its active-window outline, declarative content-rounding, native compositor, package/dependency, and live-matrix findings.
- The earlier scope and parked carrier boundary are retained here; no carrier decision is added.
...
See [Declarative QML Content Rounding](../window-visual-effects-feasibility/feasibility.md#qmldeclarative-content-rounding) and [Candidate Architectures](../window-visual-effects-feasibility/feasibility.md#candidate-architectures).
