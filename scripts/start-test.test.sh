...
assert_contains "shortcut assignments: matched 5, drift 2, missing 12"
...
assert_contains "refusing to apply with 19 project ownership error"
if [[ "$(wc -l < "$WORK/setshortcut.log")" -ne "$CALL_BASELINE" ]]; then
