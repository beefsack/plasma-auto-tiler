...
assert_contains "shortcut assignments: matched 5, drift 2, missing 11"
...
assert_contains "refusing to apply with 18 project ownership error"
if [[ "$(wc -l < "$WORK/setshortcut.log")" -ne "$CALL_BASELINE" ]]; then
