...
if(GROUP_UNWIND_COUNT LESS 8)
    message(FATAL_ERROR "group-highlight Rust validation failed: expected catch_unwind on every export (8), found ${GROUP_UNWIND_COUNT}")
endif()
...
if(NOT GROUP_SCRIPTABLE_COUNT EQUAL 3)
    message(FATAL_ERROR "group-highlight D-Bus validation failed: expected setter, clear, and read-only status Q_SCRIPTABLE methods, found ${GROUP_SCRIPTABLE_COUNT}")
endif()
foreach(GROUP_METHOD SetGroupHighlight ClearGroupHighlight GetGroupHighlightStatus)
